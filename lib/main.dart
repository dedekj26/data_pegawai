...
Future<List<Pegawai>> fetchPegawais(http.Client client) async {
  final response =
      await client.get('https://startmyflutter.000webhostapp.com/bacaData.php');
    ...
    child: Card(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          ListTile(
            title: Text(data[index].nama_pegawai, style: TextStyle(color: Colors.white)),
            subtitle: Text(data[index].nip, style: TextStyle(color: Colors.white)),
          ),
          ButtonTheme.bar(
            child: ButtonBar(
              children: <Widget>[
